...
const mdsShortcutDefinitions = <MdsShortcutDefinition>[
  ...
  MdsShortcutDefinition(
    MdsShortcutCommand.restoreDefaultConfiguration,
  ...
  MdsShortcutDefinition(
    ...
    'open_ssh_tunnel',
    'General',
    'Open SSH Tunnel dialog',
  ),
  MdsShortcutDefinition(
    MdsShortcutCommand.openShotHistory,
    'open_shot_history',
    'General',
    'Manage shot history',
  ),
  ...
  MdsShortcutDefinition(
    MdsShortcutCommand.setLightTheme,
    'theme_light',
    'General',
    'Use Light theme',
  ),
  MdsShortcutDefinition(
    MdsShortcutCommand.setAutoTheme,
    'theme_auto',
    'General',
    'Use Auto theme',
  ),
  MdsShortcutDefinition(
    MdsShortcutCommand.setDarkTheme,
    'theme_dark',
    'General',
    'Use Dark theme',
  ),
