      ...
      builder: (ctx) => StatefulBuilder(builder: (ctx, setState) {
        ...
        return Dialog(
          ...
          child: ConstrainedBox(
            constraints: BoxConstraints(maxWidth: 400, maxHeight: maxDialogHeight.clamp(200, 600)),
            child: Column(
              mainAxisSize: MainAxisSize.min,
              children: [
                const Padding(
                  padding: EdgeInsets.fromLTRB(24, 20, 24, 0),
                  child: Align(alignment: Alignment.centerLeft, child: Text('SSH Tunnel', style: TextStyle(fontSize: 20, fontWeight: FontWeight.w500))),
                ),
                Flexible(
